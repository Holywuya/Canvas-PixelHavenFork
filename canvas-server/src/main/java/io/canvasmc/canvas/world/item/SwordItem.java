...
public class SwordItem extends Item {
        ...
        if (consumable != null) {
            ...
            if (equippable != null && equippable.swappable()) {
                ...
                if (blocksAttacks != null) {
                    ...
                    if (io.canvasmc.canvas.WorldConfig.getDefaults().combat.imitateSwordBlocking) {
    ...
    public boolean releaseUsing(final ItemStack stack, final Level level, final LivingEntity entity, final int timeLeft) {
        if (io.canvasmc.canvas.WorldConfig.getDefaults().combat.imitateSwordBlocking && entity instanceof Player player && player.canvas$isTemporarilyBlocking) {
