// Canvas - Lithium - faster hash palette
// Based on Lithium (https://github.com/CaffeineMC/lithium) by 2No2Name, licensed LGPL-3.0

package io.canvasmc.canvas.lithium.common.world.chunk;
 ...
 */
@NullMarked
public final class LithiumHashPalette<T> implements Palette<T>, FastPalette<T> {
